...
var paths = {
    ...
    distImages: dist + 'spa/images',
    distSpa: dist + 'spa/',
    jsVendors: dist + 'lib/js',
    cssVendors: dist + 'lib/css',
    imgVendors: dist + 'lib/img',
    fontsVendors: dist + 'lib/fonts',
    srcAppSpa: './client/app/',
    srcAppCss: './client/css/',
    srcAppImages: './client/images/'
};

var config = {
    //Include all js files but exclude any min.js files
    src: ['client/app/**/*.js', '!client/app/**/*.min.js']
}
...
gulp.task('setup-vendors', function () {
    gulp.src([
      ...
      paths.bower + 'toastr/toastr.js.map*',
